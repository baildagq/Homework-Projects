...
struct stmt_ty{
    ...
    auto ClassDef()->decltype(&v.ClassDef);
    ...
    auto Nonlocal()->decltype(&v.Nonlocal);
    auto Global()->decltype(&v.Global);
    int lineno;
    int col_offset;
};
enum expr_ty_enum{
...
struct expr_ty{
    ...
    union{
        ...
        struct{
            expr_ty *elt;
            asdl_seq<comprehension_ty*> *generators;
        } ListComp;
        struct{
            expr_ty *value;
            identifier_ty *id;
    ...
    auto List()->decltype(&v.List);
    auto ListComp()->decltype(&v.ListComp);
    auto Attribute()->decltype(&v.Attribute);
    auto Subscript()->decltype(&v.Subscript);
    auto IfExpr()->decltype(&v.IfExpr);
    auto Dict()->decltype(&v.Dict);
    auto Yield()->decltype(&v.Yield);
